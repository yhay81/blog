...
PEP8 では python のプログラムの適切な 1 行あたりの文字数は 79 文字となっているが、これは小さい画面が主流であった古い時代のルールであるという批判があります。
black では 88 文字をデフォルトの設定としていて、僕は black の設定に基本的に乗っ取る方針ではあるが、これでも（特に長い str のハードコードなどで）不便に感じることが多いです。
